    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let selectorModel = model as? SelectorBubbleModel {
            ...
            if let dequeueCell = tableView.dequeueReusableCell(withIdentifier: "BubbleSelectorCell") as? BubbleSelectorCell {
                ...
                cell = BubbleSelectorCell.init(style: .default, reuseIdentifier: "BubbleSelectorCell")
            }
            ...
            return BubbleSelectorCell.init(style: .default, reuseIdentifier: "BubbleSelectorCell")
        }
    }
