...
extension BubbleSheet {
    private func setUpDetailUI() {
        ...
        if !configuration.bubbleTitle.isEmpty {
            ...
            let titleH = UILabel.b_labelHeight(text: configuration.bubbleTitle,
                                                 width: titleW,
        ...
        if !configuration.bubbleSubtitle.isEmpty {
            ...
            let subtitleH = UILabel.b_labelHeight(text: configuration.bubbleSubtitle,
                                                    width: subtitleW,
        ...
        if !configuration.bubbleTitle.isEmpty || !configuration.bubbleSubtitle.isEmpty {
            let topGapLineX = 0.0
            let topGapLineY = !configuration.bubbleSubtitle.isEmpty ? subtitleLabel.frame.maxY + BubbleSheet.sheetGapLine : titleLabel.frame.maxY + BubbleSheet.sheetGapLine
