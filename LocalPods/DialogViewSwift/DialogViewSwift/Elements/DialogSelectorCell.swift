...
class DialogSelectorCell: UITableViewCell {
    ...
    public var item: SelectorDialogItem = .init()

    private lazy var titleLab: UILabel = {
        let titleLab = UILabel()
        titleLab.font = UIFont.systemFont(ofSize: 16.0)
        return titleLab
    }()
    ...
    private lazy var arrowView: UIImageView = {
        ...
        arrowView.image = UIImage(named: "SelectorDialogArrow")
        return arrowView
    }()

    private lazy var selectView: UIImageView = {
        let selectView = UIImageView()
        selectView.image = UIImage(named: "SelectorDialogDot0")
        selectView.highlightedImage = UIImage(named: "SelectorDialogDot1")
        return selectView
    }()
    ...
    private func setUpDetailSelectorCell(selectorItem: SelectorDialogItem) {
    ...
    private func setUpTitleLabel(preference: SelectorPreference, selectorItem: SelectorDialogItem, imageWidth: CGFloat) {
    ...
    private func setUpImageView(preference: SelectorPreference, selectorItem: SelectorDialogItem, imageWidth: CGFloat) {
    ...
    public func makeUnderline(show: Bool) {
