...
class DialogSheetCell: UITableViewCell {
    ...
    private lazy var cellTitleLabel: UILabel = {
        ...
        cellTitleLabel.font = DialogConfig.normalFont(ofSize: 16.0)
    ...
    private lazy var cellSubtitleLabel: UILabel = {
        ...
        cellSubtitleLabel.font = DialogConfig.normalFont(ofSize: 14.0)
...
extension DialogSheetCell {
    ...
    private func addViewConstraints() {
        ...
        cellTitleLabel.snp.remakeConstraints { make in
            ...
            make.top.equalToSuperview().offset(DialogSheetCell.sheetCellTopGap)
            make.height.equalTo(DialogSheetCell.sheetCellTitleHeight)
        }

        cellSubtitleLabel.snp.remakeConstraints { make in
            make.trailing.equalToSuperview().offset(titleTrailingGap)
            make.leading.equalToSuperview().offset(titleLeadingGap)
            make.top.equalTo(self.cellTitleLabel.snp.bottom).offset(DialogSheetCell.sheetCellVGap)
            make.height.equalTo(DialogSheetCell.sheetCellSubtitleHeight)
        }
