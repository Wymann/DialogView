...
class DialogTextTool {
    ...
    /// - Returns: 富文本
    public class func createAttributedString(configuration: AttributedStringConfig) -> NSAttributedString {
    ...
    ///   - width: 控件宽度
    /// - Returns: 文本行数
    public class func calculateLines(text: String, font: UIFont, width: CGFloat) -> Int {
        if text.isEmpty {
            return 0
        }
